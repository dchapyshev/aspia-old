...
BOOL
drv_close_scsi(HANDLE hHandle)
{
    return CloseHandle(hHandle);
}

BOOL
drv_read_scsi_info(HANDLE hHandle, BYTE bDevNumber, IDSECTOR *Info)
{
...
BOOL
drv_enable_scsi_smart(HANDLE hHandle, BYTE bDevNumber, BYTE bCmd)
{
    BYTE Buf[sizeof(SRB_IO_CONTROL) + sizeof(SENDCMDOUTPARAMS) +
...
BOOL
drv_read_scsi_smart_attributes(HANDLE hHandle, BYTE bDevNumber)
{
    BYTE Buf[sizeof(SRB_IO_CONTROL) + sizeof(SENDCMDOUTPARAMS) +
...
BOOL
drv_read_scsi_smart_thresholds(HANDLE hHandle, BYTE bDevNumber)
{
    BYTE Buf[sizeof(SRB_IO_CONTROL) + sizeof(SENDCMDOUTPARAMS) +
