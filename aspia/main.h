...
WORD DRIVER_ReadIoPortWord(DWORD);
DWORD DRIVER_ReadIoPortDword(DWORD);
BYTE DRIVER_ReadIoPortByte(DWORD);
BOOL DRIVER_WriteIoPortWord(DWORD, WORD);
BOOL DRIVER_WriteIoPortDword(DWORD, DWORD);
BOOL DRIVER_WriteIoPortByte(DWORD, BYTE);
