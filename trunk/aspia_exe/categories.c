...
CATEGORY_LIST DMICategoryList[] =
{
    ...
    { IDS_CAT_HW_DMI_BIOS_LANGUAGE,      IDI_CPU,        IDR_POPUP, FALSE, TRUE, FALSE, NULL, DMI_BiosLanguageInfo,     NULL, StdColumnList, NULL },
    ...
    { IDS_CAT_HW_DMI_MEM_CTRL,           IDI_HW,         IDR_POPUP, FALSE, TRUE, FALSE, NULL, DMI_MemCtrlInfo,          NULL, StdColumnList, NULL },
    { IDS_CAT_HW_DMI_MEM_MODULE,         IDI_HW,         IDR_POPUP, FALSE, TRUE, FALSE, NULL, DMI_MemModuleInfo,        NULL, StdColumnList, NULL },
    { IDS_CAT_HW_DMI_MEM_ARRAY,          IDI_HW,         IDR_POPUP, FALSE, TRUE, FALSE, NULL, DMI_MemArrayInfo,         NULL, StdColumnList, NULL },
    { IDS_CAT_HW_DMI_PHYSIC_MEM_ARRAY,   IDI_HW,         IDR_POPUP, FALSE, TRUE, FALSE, NULL, DMI_PhysicMemArrayInfo,   NULL, StdColumnList, NULL },
    { IDS_CAT_HW_DMI_MANAGEMENT_DEV,     IDI_HW,         IDR_POPUP, FALSE, TRUE, FALSE, NULL, DMI_ManagDevInfo,         NULL, StdColumnList, NULL },
    { IDS_CAT_HW_DMI_MANAG_DEV_COMPONENT,IDI_HW,         IDR_POPUP, FALSE, TRUE, FALSE, NULL, DMI_ManagDevComponentInfo,NULL, StdColumnList, NULL },
    { IDS_CAT_HW_DMI_MANAG_DEV_THRESHOLD,IDI_HW,         IDR_POPUP, FALSE, TRUE, FALSE, NULL, DMI_ManagDevThresholdInfo,NULL, StdColumnList, NULL },
    { IDS_CAT_HW_DMI_MANAG_CTRL_HOST,    IDI_HW,         IDR_POPUP, FALSE, TRUE, FALSE, NULL, DMI_ManagCtrlHostInfo,    NULL, StdColumnList, NULL },
    ...
    { IDS_CAT_HW_DMI_TEMP_PROBE,         IDI_TEMPERATURE,IDR_POPUP, FALSE, TRUE, FALSE, NULL, DMI_TempProbeInfo,        NULL, StdColumnList, NULL },
    { IDS_CAT_HW_DMI_ELECTR_PROBE,       IDI_VOLTAGE,    IDR_POPUP, FALSE, TRUE, FALSE, NULL, DMI_ElectrProbeInfo,      NULL, StdColumnList, NULL },
    { IDS_CAT_HW_DMI_SYS_POWER_SUPPLY,   IDI_VOLTAGE,    IDR_POPUP, FALSE, TRUE, FALSE, NULL, DMI_SysPowerSupplyInfo,   NULL, StdColumnList, NULL },
    { IDS_CAT_HW_DMI_VOLTAGE_PROBE,      IDI_VOLTAGE,    IDR_POPUP, FALSE, TRUE, FALSE, NULL, DMI_VoltageProbeInfo,     NULL, StdColumnList, NULL },
    { IDS_CAT_HW_DMI_COOLING_DEVICE,     IDI_FAN,        IDR_POPUP, FALSE, TRUE, FALSE, NULL, DMI_CoolingDeviceInfo,    NULL, StdColumnList, NULL },
    { IDS_CAT_HW_DMI_SYS_EVENT_LOG,      IDI_EVENTVWR,   IDR_POPUP, FALSE, TRUE, FALSE, NULL, DMI_SysEventLogInfo,      NULL, StdColumnList, NULL },
    { IDS_CAT_HW_DMI_GROUP_ASSOCIATIONS, IDI_COMPUTER,   IDR_POPUP, FALSE, TRUE, FALSE, NULL, DMI_GroupAssocInfo,       NULL, StdColumnList, NULL },
    { IDS_CAT_HW_DMI_SYS_CONFIG_OPT,     IDI_COMPUTER,   IDR_POPUP, FALSE, TRUE, FALSE, NULL, DMI_SysConfigOptInfo,     NULL, StdColumnList, NULL },
    { IDS_CAT_HW_DMI_SYS_POWER_CTRLS,    IDI_COMPUTER,   IDR_POPUP, FALSE, TRUE, FALSE, NULL, DMI_SysPowerCtrlsInfo,    NULL, StdColumnList, NULL },
    { IDS_CAT_HW_DMI_SYS_RESET,          IDI_COMPUTER,   IDR_POPUP, FALSE, TRUE, FALSE, NULL, DMI_SysResetInfo,         NULL, StdColumnList, NULL },
    { IDS_CAT_HW_DMI_SYS_BOOT,           IDI_COMPUTER,   IDR_POPUP, FALSE, TRUE, FALSE, NULL, DMI_SysBootInfo,          NULL, StdColumnList, NULL },
    { IDS_CAT_HW_DMI_HARDWARE_SEC,       IDI_SECURITY,   IDR_POPUP, FALSE, TRUE, FALSE, NULL, DMI_HardwareSecInfo,      NULL, StdColumnList, NULL },
    { IDS_CAT_HW_DMI_REMOTE_ACCESS,      IDI_MONITOR,    IDR_POPUP, FALSE, TRUE, FALSE, NULL, DMI_RemoteAccessInfo,     NULL, StdColumnList, NULL },
    { IDS_CAT_HW_DMI_IPMI_DEVICE,        IDI_HW,         IDR_POPUP, FALSE, TRUE, FALSE, NULL, DMI_IPMIDeviceInfo,       NULL, StdColumnList, NULL },
    { IDS_CAT_HW_DMI_OEM_STRINGS,        IDI_TEXT,       IDR_POPUP, FALSE, TRUE, FALSE, NULL, DMI_OemStringsInfo,       NULL, StdColumnList, NULL },
    { 0 }
};
