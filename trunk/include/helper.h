...
#define IOCTL_WRITE_MSR         CTL_CODE(FILE_DEVICE_UNKNOWN, 12, METHOD_BUFFERED, FILE_ALL_ACCESS)
...
typedef struct _WRITE_MSR_QUERY
{
    UINT32 Register;
    UINT32 CpuIndex;
    ULARGE_INTEGER Value;
} WRITE_MSR_QUERY, *PWRITE_MSR_QUERY;
...
BOOL WriteMsr(IN UINT32 Register, IN UINT32 CpuIndex, IN UINT32 Eax, IN UINT32 Edx);
