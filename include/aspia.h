...
VOID DMI_OemStringsInfo(VOID);
VOID DMI_MemCtrlInfo(VOID);
VOID DMI_MemModuleInfo(VOID);
VOID DMI_MemArrayInfo(VOID);
VOID DMI_VoltageProbeInfo(VOID);
VOID DMI_TempProbeInfo(VOID);
VOID DMI_ElectrProbeInfo(VOID);
VOID DMI_CoolingDeviceInfo(VOID);
VOID DMI_SysPowerSupplyInfo(VOID);
VOID DMI_BiosLanguageInfo(VOID);
VOID DMI_SysEventLogInfo(VOID);
VOID DMI_GroupAssocInfo(VOID);
VOID DMI_SysConfigOptInfo(VOID);
VOID DMI_PhysicMemArrayInfo(VOID);
VOID DMI_SysResetInfo(VOID);
VOID DMI_HardwareSecInfo(VOID);
VOID DMI_SysPowerCtrlsInfo(VOID);
VOID DMI_RemoteAccessInfo(VOID);
VOID DMI_SysBootInfo(VOID);
VOID DMI_ManagDevInfo(VOID);
VOID DMI_ManagDevComponentInfo(VOID);
VOID DMI_ManagDevThresholdInfo(VOID);
VOID DMI_ManagCtrlHostInfo(VOID);
VOID DMI_IPMIDeviceInfo(VOID);
